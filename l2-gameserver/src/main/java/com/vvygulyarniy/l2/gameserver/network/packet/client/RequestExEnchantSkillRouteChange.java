...
public final class RequestExEnchantSkillRouteChange extends L2GameClientPacket {
    ...
    public RequestExEnchantSkillRouteChange(ByteBuffer buf) {
        super(buf);
    }
    ...
    protected void runImpl() {
        ...
        if (player.getSp() >= requiredSp) {
            ...
            if (Config.ES_SP_BOOK_NEEDED) {
                ...
                {
                    player.send(SystemMessageId.YOU_DONT_HAVE_ALL_ITENS_NEEDED_TO_CHANGE_SKILL_ENCHANT_ROUTE);
                    return;
                }
            }
            ...
            player.send(new ExEnchantSkillInfoDetail(3, _skillId, afterEnchantSkillLevel, player));
