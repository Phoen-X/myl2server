...
public interface CharacterRepository {
    L2Character createCharacter(L2GameClient gameClient, Profession profession, String nickName, CharacterAppearance appearance) throws CharacterCreationException;
