...
public interface CharacterRepository {
    L2Character createCharacter(L2GameClient gameClient, L2CharTemplate template, String nickName, CharacterAppearance appearance) throws CharacterCreationException;
